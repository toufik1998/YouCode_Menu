			...
			<div class="d-flex align-items-center mb-3">
				<div>
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" style="color: #ff8906">YouCode Manu || Create Plat </li>
					</ol>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-12 col-md-8">
                        <form action="{{ url('menu_plat') }}"  method="POST" id="form-task" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" id="plat-name"/>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label text-white">Plat day</label>
                                            <input type="text" name="plat_day" class="form-control" id="plat-day"/>
                                        </div>
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <textarea class="form-control" name="about_plat" rows="10" id="plat-content"></textarea>
                                        </div>
                            ...
                            <div class="modal-footer border-0">
                                ...
                                <button type="submit" name="add-multiple-post" class="btn btn-primary text-dark task-action-btn" id="task-save-btn">Add Plat</button>
                            </div>
                        </form>
                    </div>
                </div>
